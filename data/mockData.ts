...
export const points: Point[] = [
  // Categoria: Società
  {
    ...
    photos: [{ id: 'ph_m1', url: 'https://picsum.photos/seed/fontana/800/600', caption: 'Piazza Fontana oggi' }],
    linkedCharacterIds: [],
  ...
  // Categoria: Arte
  {
    ...
    photos: [{ id: 'ph_m3', url: 'https://picsum.photos/seed/cenacolo/800/600', caption: 'Il convento di Santa Maria delle Grazie' }],
  ...
  // Categoria: Cinema
  {
    ...
    photos: [{ id: 'ph_m5', url: 'https://picsum.photos/seed/galleria/800/600', caption: 'La Galleria Vittorio Emanuele II' }],
  ...
  // Categoria: Musica
  {
    ...
    photos: [{ id: 'ph_m9', url: 'https://picsum.photos/seed/vigorelli/800/600', caption: 'Velodromo Vigorelli' }],
    linkedCharacterIds: [],
