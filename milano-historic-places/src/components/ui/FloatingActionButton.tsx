...
export default function FloatingActionButton({ mode, onClick }: Props) {
  return (
    <motion.button
      ...
      className="fixed bottom-16 right-4 bg-accent-blue p-4 rounded-full shadow-lg text-white hover:bg-accent-blue/90 focus:outline-none focus:ring-2 focus:ring-accent-blue"
    >
