  ...
  return (
    <div className="p-4 space-y-4">
      {itineraries.map(it => (
        <div
          key={it.id}
          className="bg-newspaper-bg border border-neutral-light shadow rounded-xl overflow-hidden flex"
        >
          {it.image ? (
          ...
          <div className="p-4 flex-1">
            ...
            <button
              ...
              className="mt-3 inline-block bg-accent-bordeaux text-white px-4 py-2 rounded-full hover:bg-accent-gold hover:text-accent-bordeaux transition"
            >
              Avvia tour
            </button>
          </div>
